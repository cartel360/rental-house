                   ...
                   <tbody>
                     <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method = "POST">
                       <tr>
                         ...
                         <td>Kshs. <input type='text' class='form-control form-control-user' name='prev' required></td>
                       </tr>
                     ...
                     <tr>
                       ...
                       <td>
                         Kshs. <input type='text' class='form-control form-control-user' name='new' required>
                       </td>
                     </tr>
                     <tr>
                     <td></td>
