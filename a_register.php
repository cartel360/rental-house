      ...
      if(mysqli_num_rows($query) > 0){
        ...
        elseif($pword == $rpword){
          $pword = md5($pword);
            ...
            $sql= "INSERT INTO `user`(`name`, `role`, `pno`, `u_name`, `pword`, `date_reg`) VALUES ('$name','$role','$pno','$uname','$pword','$date_reg')";
          ...
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" action="<?php echo $_SERVER['PHP_SELF']; ?>" method = "POST">
                ...
                <div class="form-group row">
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="pno1" value="<?php echo @$pno; ?>" placeholder="Phone Number e.g; 254717******" required>
                  </div>
