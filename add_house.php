              ...
              <div class="table-responsive">
                <table class="table table-borderless" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                      <tr>
                        ...
                        <td><input type='text' class='form-control form-control-user' name='name' style="width:300px;" required></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <select class="custom-select" name="balcony" id="terms" style="width:300px;" required>
                            <option value="Yes" id="1">Yes</option>
                            <option value="No" id="2">No</option>
                          </select>
                        </td>
                      ...
                      <tr>
                        ...
                        <td><input type='number' class='form-control form-control-user' name='cost' style="width:300px;" required></td>
                      </tr>
                      <tr>
                        <td></td>
                  ...
                  if (isset($_POST["submit"])) {
                    ...
                    $cost =  $_POST['cost'];
                    $status =  "Empty";
                    $sql = "INSERT INTO house (house_name, compartment, balcony, rent_per_month, status) VALUES ('$house','$compartment','$balcony','$cost','$status')";
