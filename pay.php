...
if (isset($_POST['submit'])) {
  ...
  if (mysqli_num_rows($query) == 1) {
    if ($pin != $pin_no) {
      ...
      if ($amount > $amm) {
        echo "Insufficient Amount: your balance is: Kshs. ".$amm;
      } else {
        ...
        if (mysqli_num_rows($query1) == 0) {
          ...
          $sql2 = "INSERT INTO transaction (ref_no, user, recipient, amount, date) VALUES ('$ref_no','$user','$rec','$amount','$date')";
                  ...
                  <tbody>
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                      ...
                      <tr>
                        ...
                        <td><input type='text' class='form-control form-control-user' name='amount' style="width: 300px;"></td>
                      </tr>
                      <tr>
                        <td>
                          Payment From:
