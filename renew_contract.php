                ...
                <table class="table table-borderless" id="dataTable" width="100%" cellspacing="0">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <input type="radio" name="price" value = "50000" required>Kshs. 50,000&nbsp
                        <input type="radio" name="price" value = "60000">Kshs. 60,000&nbsp
                        <input type="radio" name="price" value = "70000">Kshs. 70,000&nbsp
                        <input type="radio" name="price" value = "80000">Kshs. 80,000
                      </td>
                    </tr>
                    <tr>
                      <td>
